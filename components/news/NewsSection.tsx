    ...
    return (
        <div className=" max-w-[1500px] px-3 sm:px-10 mx-auto w-full my-20 ">
            <div className=" grid grid-rows-[repeat(auto-fill,minmax(210px,1fr))] sm:grid-cols-[repeat(auto-fit,minmax(420px,1fr))] gap-5 sm:gap-8">
                <div className=" border border-[#d3d3d3] rounded-[20px] p-6 bg-white row-span-2 flex flex-col justify-between">
...
const NewsBlock = () => {
    return (
        <div className="border border-[#d3d3d3] rounded-[20px] p-6 min-h-[280px] flex flex-col justify-between">
